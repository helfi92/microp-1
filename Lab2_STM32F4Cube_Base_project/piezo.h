...
#define PIEZO_ADC_CHANNEL ADC_CHANNEL_15
#define PIEZO_ADC_CLK_EN 	__HAL_RCC_ADC2_CLK_ENABLE()

#define PIEZO_ADC_GPIO_PORT GPIOC //Port C
#define PIEZO_ADC_GPIO_PIN GPIO_PIN_4 // Pin C0 is connected to the ADC2 Channel 5 input
